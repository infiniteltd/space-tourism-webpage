...
const destNavBtn = document.getElementById("dest-nav-btn");
const crewNavBtn = document.getElementById("crew-nav-btn");
const techNavBtn = document.getElementById("tech-nav-btn");

const hamMenuIcon = document.getElementById("toggle-ham-menu").appendChild(menu1);
...
const moonDistance = document.getElementById("dis-value");
const estTravel = document.getElementById("time-value");
...
const techBtn1 = document.getElementById("num1");
const techBtn2 = document.getElementById("num2");
const techBtn3 = document.getElementById("num3");
const tecImage = document.getElementById("tech-image");
const techMain = document.getElementById("tech-main-txt");
